...
public class TrainModelForSerialize {
    ...
    public void train() throws Exception{
        ...
        List<String> commentPositivos = FileUtils.readLines(new File("C:/Users/Fernando/Desktop/weka/positivo.txt"));
        List<String> commentNegativos = FileUtils.readLines(new File("C:/Users/Fernando/Desktop/weka/negativo.txt"));
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("/home/ian/Escritorio/PPB/WEKA/svm.model"));
        ...
        FileUtils.write(new File("/home/ian/Escritorio/PPB/WEKA/attrs.dat"), attrs.toString());
